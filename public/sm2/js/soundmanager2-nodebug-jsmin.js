...
(function (ea) {
  function Q(Q, da) {
    ...
    this.ontimeout = function (a, c) {
      var d = !1;
      if ('function' === typeof a) (c || (c = h), la('ontimeout', a, c), B({ type: 'ontimeout' }));
      else throw u('needFunction', 'ontimeout');
      return !0;
    };
    ...
    this.reboot = function () {
      ...
      c.sounds = {};
      i = null;
      for (a in w) if (w.hasOwnProperty(a)) for (e = w[a].length - 1; 0 <= e; e--) w[a][e].fired = !1;
    ...
    Ca = function (a) {
        ...
        if (ba(a)) {
          ...
          try {
            ((b.isHTML5 = !1),
              ...
              (a = b._iO),
              8 === j
                ? i._load(b.id, a.url, a.stream, a.autoPlay, a.whileloading ? 1 : 0, a.loops || 1, a.usePolicyFile)
                : i._load(b.id, a.url, !!a.stream, !!a.autoPlay, a.loops || 1, !!a.autoLoad, a.usePolicyFile));
          } catch (e) {
      ...
      this.unload = function () {
        if (0 !== b.readyState) {
          if (b.isHTML5) {
            if ((I(), b._a)) (b._a.pause(), ua(b._a, 'about:blank'), (b.url = 'about:blank'));
      ...
      this.start = this.play = function (a, c) {
        ...
        if (b.paused && b.position && 0 < b.position) b.resume();
          ...
          if (
            ...
            if (b.isHTML5 && !b._html5_canplay) (b.load({ _oncanplay: e }), (d = !1));
          ...
          b.isHTML5
            ? (h(), (d = b._setup_html5()), b.setPosition(b._iO.position), d.play())
            : ((d = i._start(b.id, b._iO.loops || 1, 9 === j ? b._iO.position : b._iO.position / 1e3, b._iO.multiShot)),
              9 === j && !d && b._iO.onplayerror && b._iO.onplayerror.apply(b));
        }
        return b;
      };
      this.stop = function (a) {
      ...
      this.setPosition = function (a) {
        ...
        if (b.isHTML5) {
          ...
          ((a = 9 === j ? b.position : a),
            b.readyState && 2 !== b.readyState && i._setPosition(b.id, a, b.paused || !b.playState, b._iO.multiShot));
      ...
      this.pause = function (a) {
        ...
        b.paused = !0;
        b.isHTML5
          ? (b._setup_html5().pause(), I())
          : (a || 'undefined' === typeof a) && i._pause(b.id, b._iO.multiShot);
      ...
      this.resume = function () {
        ...
        b.playState = 1;
        b.isHTML5
          ? (b._setup_html5().play(), h())
          : (a.isMovieStar && !a.serverURL && b.setPosition(b.position), i._pause(b.id, a.multiShot));
      ...
      this._setup_html5 = function (a) {
        ...
        if (d) {
          ...
          ((b._a = a.autoLoad || a.autoPlay ? new Audio(a.url) : Pa ? new Audio(null) : new Audio()),
          (d = b._a),
          (d._called_load = !1),
          z)
        )
      ...
      this._whileplaying = function (a, c, e, d, f) {
        ...
        if (!b.isHTML5 && 8 < j) {
          ...
          if (g.useWaveformData && 'undefined' !== typeof e && e)
            b.waveformData = { left: e.split(','), right: d.split(',') };
          if (
            g.useEQData &&
            'undefined' !== typeof f &&
            f &&
      ...
      this._onconnect = function (a) {
        ...
        if ((b.connected = a))
          ((b.failures = 0),
            p(b.id) && (b.getAutoPlay() ? b.play(void 0, b.getAutoPlay()) : b._iO.autoLoad && b.load()),
    ...
    r = function (a, e) {
      ...
      for (g in b)
        b.hasOwnProperty(g) &&
          ...
          (d[g] = 'object' !== typeof b[g] || null === b[g] ? b[g] : r(d[g], b[g]));
      return d;
    };
    T = { onready: 1, ontimeout: 1, defaultOptions: 1, flash9Options: 1, movieStarOptions: 1 };
    ka = function (a, e) {
      var d,
        b = !0,
    ...
    v = {
      ...
      progress: m(function (a) {
        ...
        c.buffered = [];
        if (g && g.length) {
          for (d = 0, b = g.length; d < b; d++) c.buffered.push({ start: g.start(d), end: g.end(d) });
          g = g.end(0) - g.start(0);
          d = g / a.target.duration;
        }
        isNaN(d) ||
          (c._onbufferchange(0),
          c._whileloading(d, f, c._get_html5_duration()),
          d && f && d === f && v.canplaythrough.call(this, a));
      }),
    ...
    ba = function (a) {
      return a.serverURL || (a.type && R(a.type))
        ? !1
        : a.type
          ? P({ type: a.type })
          : P({ url: a.url }) || c.html5Only;
    };
    ua = function (a, c) {
      if (a) a.src = c;
    };
    P = function (a) {
      ...
      var e = a.url || null,
        ...
        d = c.audioFormats,
        b;
      if (a && 'undefined' !== typeof c.html5[a]) return c.html5[a] && !R(a);
      if (!x) {
        x = [];
      ...
      b && 'undefined' !== typeof c.html5[b]
        ? (e = c.html5[b] && !R(b))
        : ((a = 'audio/' + b), (e = c.html5.canPlayType({ type: a })), (e = (c.html5[b] = e) && c.html5[a] && !R(a)));
      return e;
    };
    Ma = function () {
      function a(a) {
      ...
      for (d in f)
        if (
          ...
          (g[d] = a(f[d].type)),
          (g[b] = g[d]),
          d.match(Sa) ? ((c.flash[d] = !0), (c.flash[b] = !0)) : ((c.flash[d] = !1), (c.flash[b] = !1)),
          f[d] && f[d].related)
        )
          for (b = f[d].related.length - 1; 0 <= b; b--)
            ((g['audio/' + f[d].related[b]] = g[d]),
              (c.html5[f[d].related[b]] = g[d]),
              (c.flash[f[d].related[b]] = g[d]));
    ...
    ma = function () {
      ...
      8 < j
        ? ((c.defaultOptions = r(c.defaultOptions, c.flash9Options)),
          (c.features.buffering = !0),
          (c.defaultOptions = r(c.defaultOptions, c.movieStarOptions)),
          (c.filePatterns.flash9 = RegExp('\\.(mp3|' + Va.join('|') + ')(\\?.*)?$', 'i')),
      ...
      if (!a._hasTimer)
        ((a._hasTimer = !0),
          !za &&
            ...
            (null === O && 0 === $ && (O = h.setInterval(Ka, c.html5PollingInterval)), $++));
    };
    Ja = function (a) {
    ...
    F = function (a) {
      ...
      'function' === typeof c.onerror && c.onerror.apply(h, [{ type: 'undefined' !== typeof a.type ? a.type : null }]);
    ...
    W = function (a, e) {
      ...
      if (
        null !== c.wmode &&
        (q.match(/msie 8/i) || (!y && !c.useHighPerformance)) &&
      ...
      if (y)
        ((b = l.createElement('div')),
          (i = [
            ...
            d('bgcolor', c.bgColor),
            d('hasPriority', 'true'),
            c.debugFlash ? d('FlashVars', f.FlashVars) : '',
            '</object>'
          ].join('')));
      else for (h in ((b = l.createElement('embed')), f)) f.hasOwnProperty(h) && b.setAttribute(h, f[h]);
      qa();
      j = G();
      if ((f = pa()))
        if (((c.oMC = S(c.movieID) || l.createElement('div')), c.oMC.id)) {
          ...
          if (!c.useFlashBlock)
            ...
            else if (((j = { position: 'absolute', width: '6px', height: '6px', top: '-9999px', left: '-9999px' }), m))
    ...
    V = function () {
      ...
      i = c.getMovie(c.id);
      if (!i)
        (M ? (y ? (c.oMC.innerHTML = ra) : c.oMC.appendChild(M), (M = null), (J = !0)) : W(c.id, c.url),
          (i = c.getMovie(c.id)));
          ...
          c.audioFormats.hasOwnProperty(a) &&
            e.push(
              a +
                ': ' +
                c.html5[a] +
                (!c.html5[a] && t && c.flash[a]
                  ? ' (using flash)'
                  : c.preferFlash && c.flash[a] && t
                    ? ' (preferring flash)'
                    : !c.html5[a]
    ...
    L = function (a) {
      ...
      if (!c.useFlashBlock || !c.flashLoadTimeout || c.getMoviePercent())
        ((k = !0), s && (d = { type: !t && n ? 'NO_FLASH' : 'INIT_TIMEOUT' }));
      if (s || a) {
    ...
    Da = function () {
      ...
      for (a in e)
        e.hasOwnProperty(a) &&
          ('undefined' === typeof c[a] ? (c[a] = e[a]) : c[a] !== e[a] && (c.setupOptions[a] = c[a]));
    };
    ia = function () {
      if (k) return !1;
      if (c.html5Only) {
      ...
      try {
        ...
        return (F({ type: 'JS_TO_FLASH_EXCEPTION', fatal: !0 }), X(!0), L(), !1);
      }
      L();
    ...
    E = function () {
      ...
      Da();
      qa();
      !t && c.hasHTML5 && c.setup({ useHTML5Audio: !0, preferFlash: !1 });
      Ma();
      c.html5.usingFlash = La();
      n = c.html5.usingFlash;
      Oa();
      !t && n && c.setup({ flashLoadTimeout: 1 });
    ...
    l.addEventListener
      ...
      : l.attachEvent
        ? l.attachEvent('onreadystatechange', va)
