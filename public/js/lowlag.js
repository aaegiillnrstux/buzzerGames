  ...
  this.init = function (config) {
    ...
    switch (format) {
      case 'audioContext':
        ...
        if (
          (this.useSuspension &=
            'suspend' in lowLag.audioContext && 'onended' in lowLag.audioContext.createBufferSource())
        ) {
          this.playingQueue = [];
      ...
      case 'sm2':
        ...
        soundManager.setup({ url: lowLag.sm2url, useHighPerformance: true, onready: lowLag.sm2Ready, debugMode: true });
